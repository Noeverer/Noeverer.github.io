...
# 引用python代码文件
[cls-test.py](/source/resources/openmanus/cls-test.py)
[model_validator_test.py](/source/resources/openmanus/model_validator_test.py)
[property_example.py](/source/resources/openmanus/property_example.py)
